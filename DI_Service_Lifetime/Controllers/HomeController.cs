...
namespace DI_Service_Lifetime.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ISingletonGuidService singleton1, ISingletonGuidService singleton2, IScopedGuidService scoped1, IScopedGuidService scoped2, ITransientGuidService transient1, ITransientGuidService transient2)
        {
